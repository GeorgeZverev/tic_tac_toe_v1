...
def compute_better_coordinate(board: [], token: str, valid_coordinates: []):
    ...
    while True:
        ...
        if winning_coordinate is not None:
            ...
            proposed_coordinate = propose_best_coordinate(proposed_coordinate, combined_list, token, board, x, y)
...
def propose_best_coordinate(coordinate: str, combined_list: [], token: str, board: [], x: int, y: int) -> str:  # free coord max times and free, selected list , 3 - 3
